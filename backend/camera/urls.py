...
from .views.api_views import set_guard_zone, get_guard_zone, preview_guard_zone, get_radar_data
...
urlpatterns = [
    ...
    path('api/radar/data/', get_radar_data, name='get_radar_data'),
    ...
    path('api/yolo/preview-guard-zone/<str:camera_id>/', preview_guard_zone, name='preview_guard_zone'),
