...
#define NET_PERSON_ITEM_MAX_NUM					30		///< 每次获取人脸库人员的最大数量
#define NET_GET_ERR_PERSON_ITEM_MAX_NUM			100		///< 每次获取错误信息人员的最大数量
#define NET_PER_DEL_PERSON_MAX_NUM				30		///< 每次删除人员的最大数量
...
#define NET_FACE_SNAP_ITEM_MAX_NUM				30		///< 智能检索每次获取人员的最大数量
...
enum EMsgType
{
	...
	MSGTYPE_CMP_ALARM			= 3,	///< 比对报警消息，消息体TNetCmpAlarmItem
	MSGTYPE_PIC_UPLOAD_STATUS	= 4,	///< 图片上传状态消息，消息体TNetPicUploadStatus
};
...
enum ECtrlLibExportState
{
	...
	CTRLLIBEXPORTSTATE_EXPORTING		= 0x0008, ///< 导入中
...
enum EAlgType
{
	...
	ALGTYPE_ALL_DETECT			= 0x0008, ///< 人脸和车辆检测
};
...
enum EAipUploadMode
{
	AIPUPLOADMODE_SMALL 			= 0x0001,		///< 小图
	AIPUPLOADMODE_BODY 				= 0x0002,		///< 全身照
	AIPUPLOADMODE_BG 				= 0x0004,		///< 原图
	AIPUPLOADMODE_SBG 				= 0x0008,		///< 小图加原图
	AIPUPLOADMODE_SMALL_THUMBNAIL	= 0x0010,		///< 小图加缩略图
	AIPUPLOADMODE_ALL 				= 0x0020,		///< 全部
};
...
struct TNetMsgItem
{
	...
	void *pData;		///< 数据
	s32 nDataLen;		///< 数据长度
	u32 dwData;			///< MSGTYPE_FACE_DETECT_SNAP、MSGTYPE_CAR_DETECT_SNAP：当天抓拍人脸或车辆的总数
	// void *pParam;	///< 回调函数参数
}NETPACKED;
...
{
	s32 nChnId;									///< 通道id
	u32 dwSwitchMask;							///< 支持的开关(EIspBasicMode组合值)
 ...
 * @return 成功返回NET_OK，失败返回错误码
 */
NVR_API s32 STDCALL NET_GetCtrlLibImportState(u32 dwHandle, TNetCtrlLibExportState *ptCtrlLibExportState);
